    ...
    <NuxtLayout name="landing">
      <div>
        <main class="mx-auto max-w-7xl px-4 mt-16 sm:px-6 lg:px-0">
          ...
          <div>
            <p class="px-4 pt-10">Ojeeco Consulting Limited is dedicated to achieving these goals, guided by its vision and mission, to
