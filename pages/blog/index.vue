  ...
  <NuxtLayout name="landing">
    <div>
      <main class="mx-auto max-w-7xl px-4 mt-16 sm:px-6 lg:px-0">
        ...
        <div class="md:flex justify-around py-3">
          <div class="max-w-sm flex flex-col items-start relative z-10 p-6 xl:p-8 bg-[#6366f1] px-2 py-10 rounded-xl mb-4">
            <h2 class="text-xl text-white font-semibold mb-2">Global Expansion Facilitation</h2>
            <p class="mb-4 text-white text-sm hover:text-shadow">Facilitate the seamless expansion of clients into international markets, primarily focusing on China and India. Establish strategic partnerships with key players in diverse industries to enhance global reach.</p>
            <button class="mt-auto text-white text-shadow hover:bg-opacity-75 transition-colors bg-indigo-800 duration-200 rounded-xl font-semibold py-2 px-4 inline-flex">Explore My Work</button>
          </div>
          <div class="max-w-sm flex flex-col items-start relative z-10 p-6 xl:p-8 bg-[#f43f5e] px-2 py-10 rounded-xl mb-4">
            <h2 class="text-xl text-white font-semibold mb-2">Innovation and Technology Leadership</h2>
          ...
          <div class="max-w-sm flex flex-col items-start relative z-10 p-6 xl:p-8 bg-[#f97316] px-2 py-10 rounded-xl mb-4">
            <h2 class="text-xl text-white font-semibold mb-2">Client Satisfaction and Long-Term Relationships</h2>
            <p class="mb-4 text-white text-sm hover:text-shadow">Achieve high levels of client satisfaction through personalized service, understanding client needs, and delivering value-driven solutions.Foster long-term relationships with clients, becoming a trusted partner in their growth and success.</p>
        ...
        <div class="md:flex justify-around">
          <div class="max-w-sm flex flex-col items-start relative z-10 p-6 xl:p-8 bg-[#6366f1] px-2 py-10 rounded-xl mb-4">
            <h2 class="text-xl text-white font-semibold mb-2">Operational Excellence and Lean Practices</h2>
            <p class="mb-4 text-white text-sm hover:text-shadow">Continuously optimize internal operations using lean manufacturing principles to enhance efficiency and reduce costs.Achieve industry-leading standards in project management, ensuring timely and successful execution of client projects.</p>
            <button class="mt-auto text-white text-shadow hover:bg-opacity-75 transition-colors bg-indigo-800 duration-200 rounded-xl font-semibold py-2 px-4 inline-flex">Explore My Work</button>
          </div>
          <div class="max-w-sm flex flex-col items-start relative z-10 p-6 xl:p-8 bg-[#f43f5e] px-2 py-10 rounded-xl mb-4">
            <h2 class="text-xl text-white font-semibold mb-2">Community and Environmental Responsibility</h2>
            <p class="mb-6 text-white text-sm hover:text-shadow">Contribute positively to the communities in which we operate by engaging in socially responsible initiatives.Incorporate environmentally sustainable practices into our operations, aligning with global standards for corporate responsibility.</p>
            <button class="mt-auto text-white text-shadow hover:bg-opacity-75 transition-colors bg-rose-900 duration-200 rounded-xl font-semibold py-2 px-4 inline-flex">Access Resources</button>
          </div>
          <div class="max-w-sm flex flex-col items-start relative z-10 p-6 xl:p-8 bg-[#f97316] px-2 py-10 rounded-xl mb-4">
            <h2 class="text-xl text-white font-semibold mb-2">CONNECTING WITH THE RIGHT PARTNERS</h2>
            <p class="mb-4 text-white text-sm hover:text-shadow">Ojeeco Consulting Ltd is dedicated to achieving these goals, guided by its vision and mission, to create a lasting impact on the global business landscape.</p>
            <button class="mt-auto text-white text-shadow hover:bg-opacity-75 transition-colors bg-orange-600 duration-200 rounded-xl font-semibold py-2 px-4 inline-flex">View Documentation</button>
          </div>
        </div>
